...
6. Users should be able to add reviews for products.
...
5. Add and View Reviews
    ...
    The user can add reviews for products and view the reviews added by other users. This feature allows users to share their experience with the products and learn from others before making a purchase.
...
- `Reviews` (The reviews added by users for different products)
